...
public class EarthQuake implements Parcelable {
    ...
    public static final Creator<EarthQuake> CREATOR
        ...
        public org.me.gcu.earthquakecw.EarthQuake createFromParcel(Parcel in) {
            return new org.me.gcu.earthquakecw.EarthQuake(in);
        }

        public org.me.gcu.earthquakecw.EarthQuake[] newArray(int size) {
            return new org.me.gcu.earthquakecw.EarthQuake[size];
        }
    };
}